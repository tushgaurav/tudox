  ...
  return (
    <>
      <div className="container">
        ...
        <div>
          <p>
            Welcome to tudox, where simplicity meets productivity. Our mission
            is to provide you with a todo app that is not only incredibly simple
            to use but also enhances your efficiency and helps you stay
            organized.
          </p>
          ...
          <p>
            Whether you're a student juggling assignments, a professional
            managing deadlines, or a busy parent organizing household chores,
            our app is here to simplify your life. With just a few taps, you can
            create, prioritize, and track your tasks effortlessly. We've
            eliminated any unnecessary complexity, ensuring that you can
            navigate through the app seamlessly and stay in control of your
            productivity.
          </p>
        </div>
        ...
        <div>
          ...
          <p>
            ...
            with the lack of simple todo apps on the market. We wanted to create
            a todo app that was not only simple to use but also enhanced our
          ...
          <p>
            We have not finialized the pricing and subscription model yet, but
            we are considering a freemium model with a free tier for students
            and teachers. We are also considering a subscription model for
        ...
        <div>
          ...
          <p>
            We are still working on improving the app and adding new features.
            If you have any feedback or suggestions, please feel free to contact
            us at tudox@tushgaurav.in
          </p>
        </div>
      </div>
      <Footer />
